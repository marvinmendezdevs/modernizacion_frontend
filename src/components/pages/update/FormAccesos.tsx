...
function FormAccesos() {
  ...
  const onSubmit = (values: FormValues) => {
    const payload: metricData = {
      dateReported: new Date(values.dateReported),
    ...
    <div>
      ...
      >
        <fieldset>
          <div className="grid md:grid-cols-3 gap-3">
            ...
            <div className="flex flex-col">
              ...
              <input type="text" className="border border-gray-200 p-2 rounded-lg text-gray-700 cursor-not-allowed bg-gray-100" readOnly value={"Accesos"}/>
              {errors.type?.message && (
        ...
        {(Object.keys(sectionTitles) as SectionKey[]).map((sectionKey) => (
          <details key={sectionKey} className="border border-gray-200 rounded-xl p-4 group cursor-pointer">
